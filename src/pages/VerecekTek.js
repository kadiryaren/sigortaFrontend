...
export default function VerecekTek(props) {
	...
	const { alacakId, isId, isTuru, verecekId, erisimKodu } =
						...
						<div className="d-flex flex-column justify-content-center align-items-center w-75 h-100  rounded">
							...
							<div className="d-flex flex-column justify-content-center align-items-center">
								<label htmlFor="aciklama" className="input-group">
									<span className="w-40 flex justify-center">Açıklama</span>
									<input
								...
								<label htmlFor="miktar" className="input-group">
									<span className="w-40 flex justify-center">Miktar</span>
									<input
										className="form-control"
										onChange={(e) => {
								...
								<div className="flex justify-center">
									<div className="d-flex justify-content-center">
										<a
											onClick={silClick}
											className="btn btn-error rounded mx-2 hover:text-slate-50"
										>
											Sil
										</a>
									</div>
