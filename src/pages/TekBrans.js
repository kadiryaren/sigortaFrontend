...
export default function TekBrans(props) {
    ...
    const sil = async () => {
        const response = await fetch("http://127.0.0.1:5000/brans/sil/",{
            method:"POST",
            mode:'cors',
            headers:{
    ...
    <div>
        ...
        <div className="drawer ">
            ...
            <div className="drawer-content w-screen h-screen flex flex-column  align-center">
                ...
                <div style={{"height":"15%",'font-size':'30px'}} className="w-100 bg-success rounded d-flex justify-content-center align-items-center">Firma Adi</div>
