...
export default function IsOrtakFirmaGoster() {
    ...
    const fetchData = async () => {
        const response = await fetch("http://127.0.0.1:5000/is/ortak/firma/goster/hepsi/",{
            method:"POST",
            mode:"cors",
            headers:{
                'Content-Type':'application/json'
            ...
            <div className="drawer-content">
                ...
                <div className="container my-5">
                    ...
                    <div className="d-flex w-100 justify-content-center align-items-center mt-4">
                        <a onClick={silClick} className='btn bg-red-500 text-black mx-2 hover:bg-red-300 hover:text-white'>Firma Sil</a>
                        <a onClick={guncelle} className='btn bg-green-500 text-black mx-2 hover:bg-green-300 hover:text-white'>Firma Güncelle</a>
                    </div>
