...
export default function TekKullanici(props) {
    ...
    const sil = async () => {
        const response = await fetch("http://127.0.0.1:5000/kullanici/sil/",{
            method:"POST",
            mode:'cors',
            headers:{
                'Content-Type':'application/json'
        ...
        console.log(typeof(returnVAL.durum));
    ...
    <div>
        ...
        <div className="drawer ">
            ...
            <div className="drawer-content w-screen h-screen flex flex-column  align-center">
                ...
                <div style={{'height':'100%'}} className="container mx-auto my-5 flex flex-col  items-center ">
                ...
                <div className="d-flex w-100 h-100">
                    {/* <div style={{'height':'100%'}} className="d-flex w-100 flex-column bg-danger justify-content-start align-items-center mt-5">
                        ...
                        <ul className='mt-3'>
                            ...
                            <li className='mt-2'>
                                <b className='mr-3'>Oturum acma izni </b>
