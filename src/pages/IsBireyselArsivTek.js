					...
					<div className="w-100 h-100 d-flex justify-content-center align-items-start  h-25">
						<div className="d-flex flex-column justify-content-center align-items-center w-75 h-100  rounded">
							...
							<div className="d-flex justify-content-center">
								<a
									onClick={goruntule}
									className="btn btn-success text-black hover:btn-ghost rounded mx-2"
								>
									Musteriye Yapilan Isleri Gor
								</a>
								<a
									onClick={guncelle}
									className="btn btn-info hover:btn-ghost rounded mx-2"
								>
									Güncelle
								</a>
								<a
									onClick={silClick}
									className="btn bg-danger hover:btn-ghost rounded mx-2"
								>
									Sil
								</a>
							</div>
